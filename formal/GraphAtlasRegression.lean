...
both finite-sum formulas remain unchanged. Density continuity, boundedness,
and coarea also hold for this refinement without assuming disjoint charts, a
multiplicity bound, or discarded seams.
-/
